...
1.  **Read Core Logs**
    ...
    - `fivecircles/architecture/todolist.md`: Identify pending tasks and active assignments for Team C.
    - `fivecircles/agent/sync.md`: Review recent announcements, sprint goals, and handover notes.
    - `fivecircles/requirements/debates/README.md`: Check for any ongoing or recently resolved debates that might affect the current work.

2.  **Check Agent-Bridge Queue**
    - Run the agent-bridge task list (pending/assigned).
    - Identify open tasks, owners, and blockers that require coordination.
